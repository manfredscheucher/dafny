...
class Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(private val _0: T0, private val _1: T1, private val _2: T2, private val _3: T3, private val _4: T4, private val _5: T5, private val _6: T6, private val _7: T7, private val _8: T8, private val _9: T9, private val _10: T10, private val _11: T11, private val _12: T12) {

    companion object {
        fun <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> _typeDescriptor(_td_T0: TypeDescriptor<T0>, _td_T1: TypeDescriptor<T1>, _td_T2: TypeDescriptor<T2>, _td_T3: TypeDescriptor<T3>, _td_T4: TypeDescriptor<T4>, _td_T5: TypeDescriptor<T5>, _td_T6: TypeDescriptor<T6>, _td_T7: TypeDescriptor<T7>, _td_T8: TypeDescriptor<T8>, _td_T9: TypeDescriptor<T9>, _td_T10: TypeDescriptor<T10>, _td_T11: TypeDescriptor<T11>, _td_T12: TypeDescriptor<T12>): TypeDescriptor<Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> =
            TypeDescriptor.referenceWithInitializer { Default(_td_T0.defaultValue(), _td_T1.defaultValue(), _td_T2.defaultValue(), _td_T3.defaultValue(), _td_T4.defaultValue(), _td_T5.defaultValue(), _td_T6.defaultValue(), _td_T7.defaultValue(), _td_T8.defaultValue(), _td_T9.defaultValue(), _td_T10.defaultValue(), _td_T11.defaultValue(), _td_T12.defaultValue()) } as TypeDescriptor<Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>
        fun <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> Default(_default_T0: T0, _default_T1: T1, _default_T2: T2, _default_T3: T3, _default_T4: T4, _default_T5: T5, _default_T6: T6, _default_T7: T7, _default_T8: T8, _default_T9: T9, _default_T10: T10, _default_T11: T11, _default_T12: T12): Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> = create(_default_T0, _default_T1, _default_T2, _default_T3, _default_T4, _default_T5, _default_T6, _default_T7, _default_T8, _default_T9, _default_T10, _default_T11, _default_T12)
        fun <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> create(_0: T0, _1: T1, _2: T2, _3: T3, _4: T4, _5: T5, _6: T6, _7: T7, _8: T8, _9: T9, _10: T10, _11: T11, _12: T12): Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> = Tuple13(_0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12)
    }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other == null || this::class != other::class) return false
        val o = other as Tuple13<*, *, *, *, *, *, *, *, *, *, *, *, *>
        return this._0 == o._0 && this._1 == o._1 && this._2 == o._2 && this._3 == o._3 && this._4 == o._4 && this._5 == o._5 && this._6 == o._6 && this._7 == o._7 && this._8 == o._8 && this._9 == o._9 && this._10 == o._10 && this._11 == o._11 && this._12 == o._12
    }
